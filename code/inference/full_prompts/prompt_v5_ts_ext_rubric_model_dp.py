def create_prompt_v5_ts_ext_rubric_model_dp(student_answer_complete):
...
Verwende zusätzlich die Musterlösung in <musterloesung> als Referenz für die Bewertung; die Musterlösung enthält eine vollständige, ausformulierte Falllösung und ist als maßgeblicher Vergleichsmaßstab für die Punktevergabe heranzuziehen.
